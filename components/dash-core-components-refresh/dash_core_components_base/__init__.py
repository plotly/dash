...
_this_module = "dash_core_components_refresh"
...
_js_dist.extend(
    [
        {
            "relative_package_path": "dcc_refresh/async-{}.js".format(async_resource),
            "external_url": (
...
_js_dist.extend(
    [
        {
            "relative_package_path": "dcc_refresh/async-{}.js.map".format(async_resource),
            "external_url": (
                "https://unpkg.com/dash-core-components@{}"
...
_js_dist.extend(
    [
        {
            "relative_package_path": "dcc_refresh/{}.js".format(_this_module),
            "external_url": (
                "https://unpkg.com/dash-core-components@{}"
        ...
        {
            "relative_package_path": "dcc_refresh/{}.js.map".format(_this_module),
            "external_url": (
                "https://unpkg.com/dash-core-components@{}"
        ...
        {
            "relative_package_path": "dcc_refresh/{}-shared.js".format(_this_module),
            "external_url": (
                "https://unpkg.com/dash-core-components@{}"
        ...
        {
            "relative_package_path": "dcc_refresh/{}-shared.js.map".format(_this_module),
            "external_url": (
                "https://unpkg.com/dash-core-components@{}"
