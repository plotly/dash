...
Available events: 'restyle', 'relayout', 'click'"""
    @_explicitize_args
    def __init__(self, children=None, optionalArray=Component._NO_DEFAULT_ARG, optionalBool=Component._NO_DEFAULT_ARG, optionalFunc=Component._NO_DEFAULT_ARG, optionalNumber=42, optionalObject=Component._NO_DEFAULT_ARG, optionalString='hello world', optionalSymbol=Component._NO_DEFAULT_ARG, optionalNode=Component._NO_DEFAULT_ARG, optionalElement=Component._NO_DEFAULT_ARG, optionalMessage=Component._NO_DEFAULT_ARG, optionalEnum=Component._NO_DEFAULT_ARG, optionalUnion=Component._NO_DEFAULT_ARG, optionalArrayOf=Component._NO_DEFAULT_ARG, optionalObjectOf=Component._NO_DEFAULT_ARG, optionalObjectWithShapeAndNestedDescription=Component._NO_DEFAULT_ARG, optionalAny=Component._NO_DEFAULT_ARG, customProp=Component._NO_DEFAULT_ARG, customArrayProp=Component._NO_DEFAULT_ARG, id=Component._NO_DEFAULT_ARG, **kwargs):
