...
storiesOf('DashTable/Dropdown', module)
    .add('dropdown when data are loading (disabled)', () => <DataTable
        setProps={setProps}
        id='table'
        data={data}
        columns={columns}
    ...
    />).add('dropdown when another prop is loading (not disabled)', () => <DataTable
        setProps={setProps}
        id='table'
        data={data}
        columns={columns}
    ...
    />).add('dropdown when nothing in the table is loading (not disabled)', () => <DataTable
        setProps={setProps}
        id='table'
        data={data}
        columns={columns}
