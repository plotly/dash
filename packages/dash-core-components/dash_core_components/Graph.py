...
(use default width or height values otherwise)
  ...
  - doubleClickDelay (number; optional): Delay for registering a double-click event in ms. The
...
By default this is false.
  - showEditInChartStudio (boolean; optional): Should we show a modebar button to send this data to a
