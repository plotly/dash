...
### Fixed
- [#2102](https://github.com/plotly/dash/pull/2102) Fix bug as reported in [dash-labs #113] where files starting with `.` were not excluded when building `dash.page_registry`.
